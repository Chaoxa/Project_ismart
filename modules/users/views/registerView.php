    ...
    <div id="wrapper">
        <form action="" id="form-login" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" placeholder="Họ và tên" name="fullname" value="<?php echo set_value('fullname') ?>">
            </div>
            <div class="form-group">
                <i class="far fa-user icon"></i>
            ...
            <div class="form-group">
                <i class="fas fa-key"></i>
                <input type="password" class="form-input" placeholder="Xác nhận mật khẩu" name="confirm-password">
                <div id="eye">
                    <i class="far fa-eye icon"></i>
                </div>
            </div>
            <input type="submit" value="Đăng kí ngay" class="form-submit mb-2" name="btn-submit">
            ...
            <p> <?php global $notify;
                if (!empty($notify['add'])) {
                    ...
                    echo "<p class='text-white pt-3 m-0'>Bạn đã có tài khoản? <a href='?mod=users&controller=index&action=login'><b>Đăng nhập </b></a>ngay</p>";
                } ?></p>
        </form>
    </div>
