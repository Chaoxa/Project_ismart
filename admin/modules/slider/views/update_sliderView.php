            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" name="slug" id="slug" value="<?php echo $list_slider['link'] ?>">
                        <label for="sort">Thứ tự</label>
                        <input type="number" name="sort" min=1 max=10 id="sort-order" class="mb-2" value="<?php echo $list_slider['sort'] ?>">
                        <?php echo form_error('sort') ?>
                        <label>Hình ảnh</label>
                        <div id="uploadFile">
                            <input type="file" name="file_upload" id="file_upload" onchange="chooseFile(this)">
                            <img src="<?php echo format_link_image($list_slider['thumb_main'], 'admin/'); ?>" alt="" id="image" class="img-rounded my-2" width="300">
                            <?php echo form_error('file_upload') ?>
                        </div>
                        <button type="submit" name="btn-submit" id="btn-submit" class="mt-4 btn btn-success">Cập nhật</button>
                    </form>
                </div>
                <script>
