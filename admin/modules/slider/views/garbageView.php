...
$list_slider = get_pagging1('tbl_slide', "`status` = '1'");
foreach ($list_slider as &$value) {
    $value['url_restore'] = "?mod=slider&action=restore&id={$value['id']}";
    $value['url_delete'] = "?mod=slider&action=delete_slider&id={$value['id']}";
}
?>
                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="?mod=slider&action=list_slider">Tất cả <span class="count"><?php echo '(' . count_amount('tbl_slide') . ')' ?></span></a> |</li>
                            ...
                            <tbody>
                                ...
                                foreach ($list_slider as &$value) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span>
                                                <a href="<?php echo $value['url_restore'] ?>" title="Khôi phục" class="edit"><i class="fa fa-trash text-success px-1" aria-hidden="true"></i></a></li>
                                                <a href="<?php echo $value['url_delete'] ?>" title="Xóa hẳn" class="delete"><i class="fa fa-trash text-danger px-1" aria-hidden="true"></i></a></li>
                                            </span>
                                        </td>
                                    </tr>
                                <?php } ?>
