<div id="sidebar" class="fl-left">
    <ul id="sidebar-menu">
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=page&action=add_page" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=page&action=list_page" title="" class="nav-link">Danh sách các trang</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=post&action=add_post" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=post&action=list_post" title="" class="nav-link">Danh sách bài viết</a>
                </li>
                <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?mod=product&action=cat_product" title="" class="nav-link">Danh mục sản phẩm</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=widget&action=add_widget" title="" class="nav-link">Thêm mới</a>
                </li>
                <li class="nav-item">
                    <a href="?mod=widget&action=list_widget" title="" class="nav-link">Danh sách khối</a>
                </li>
                <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?mod=slider&action=list_slider" title="" class="nav-link">Danh sách slider</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="?mod=media&action=list_media" title="" class="nav-link">Danh sách media</a>
                </li>
            </ul>
        </li>
    </ul>
